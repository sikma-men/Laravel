...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/edit-location.css') }}">
</head>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="form-map-container">
            <form action="{{ route('update-location', $location->id) }}" method="POST" class="form-container">
                @csrf
                @method('PUT')
                <div>
                ...
                <div>
                    ...
                    <select id="category" name="category" required autocomplete="off">
                        ...
                        <option value="rumah sakit" {{ $location->category == 'rumah sakit' ? 'selected' : '' }}>Rumah
                            Sakit
                        </option>
                        <option value="sekolah" {{ $location->category == 'sekolah' ? 'selected' : '' }}>Sekolah
                        </option>
                        ...
                        <option value="pom bensin" {{ $location->category == 'pom bensin' ? 'selected' : '' }}>Pom
                            Bensin
                        </option>
                        <option value="rumah makan" {{ $location->category == 'rumah makan' ? 'selected' : '' }}>Rumah
                            Makan
                        </option>
                    </select>
                </div>
